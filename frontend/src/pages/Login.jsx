  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl bg-gray-800 p-8 shadow-lg text-slate-100">
        ...
        <div className="mt-4">
          <button onClick={continueWithGoogle} disabled={oauthLoading} className="w-full flex items-center justify-center gap-2 rounded-full px-4 py-2 bg-slate-700/60 text-slate-100 disabled:opacity-60">
            <FcGoogle size={22} />
