  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
        <h2 className="mb-1 text-center text-3xl font-extrabold text-rose-600">Create Account</h2>
        <p className="mb-6 text-center text-slate-500">Join the Peer Support community today</p>
